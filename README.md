...
| always_use_toggle_file       | By default, Findex avoids watching toggle file(`~/.config/findex/toggle_file`) when it can bind shortcut key by itself. Enabling this makes it possible to launch Findex by both means. | Boolean |
